 ...
 *
 * Five materials are the exception, each already drawn by a mesh elsewhere:
...
export const PROP_DRAWN_ELSEWHERE: ReadonlySet<string> = new Set(["trunk", "rock", "cliff", "car", "kiosk"]);
